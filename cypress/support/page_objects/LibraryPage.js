...
export class LibraryPage{
    ...
    editMessage(){
        ...
        cy.get('[class="icon_button btn_canned_menu_action btn_canned_edit fa fa-pencil-square-o"]').first().click()
        cy.wait(5000)
        // cy.xpath('//*[@id="canned_post_32502159"]/div/div[2]/div/div/div[4]/div[2]').click()
        cy.get('.ComponentMessageEditor').type("Edit test")
        cy.get('.bbm-modal__bottombar').find('.gray_button').click()
